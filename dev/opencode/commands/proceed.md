---
description: Execute a plan — from direct file, /brief output, or live chat
agent: build
---
...
1. Most recent /brief output — implement that plan
2. Agreed implementation steps from live chat — implement them
3. Neither exists — state "Nothing to proceed on" and stop
