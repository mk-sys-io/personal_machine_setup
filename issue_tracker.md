...
**Resolution**: Added `xkb_numlock enabled` to the `input *` block in
`.config/sway/sway_config`. Sway applies this during startup — no external
packages, udev rules, or boot scripts needed. The current implementation
